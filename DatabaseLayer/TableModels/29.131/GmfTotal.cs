...
public class GmfTotal
{
    ...
    public virtual GmfPunct gmfPunct {get;set;} = null!;

    public virtual GmfClass3 gmfClass3 {get;set;} = null!;

    public virtual GmfClass5 gmfClass5 {get;set;} = null!;
