namespace api_fact_weather_by_city.JSONModels._29._131
{
    public class GmfTotalJson
    {
        ...
        public virtual GmfPunctJson gmfPunct {get;set;} = null!;

        public virtual GmfClass3Json gmfClass3 {get;set;} = null!;

        public virtual GmfClass5Json gmfClass5 {get;set;} = null!;
    }
}
